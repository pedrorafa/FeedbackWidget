...
interface StepSuccessFeedbackProps {
    backToFeedbackType: () => void,
}

export function StepSuccessFeedback({ backToFeedbackType: onBackToFeedbackType }: StepSuccessFeedbackProps) {
    return (
        <>
            <WidgetHeader title='Feedback Enviado' />
